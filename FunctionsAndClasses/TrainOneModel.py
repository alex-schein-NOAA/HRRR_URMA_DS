...
def TrainOneModel(current_model_attrs,
    ...
    for epoch in range(1,upper_bound):
        ...
        if epoch_loss <= lowest_loss: #only save models that have lower loss than previous best
            ...
            # Saving model.module.state_dict should alos be good for DDP, based on save
        ...
        # If loss suddenly gets huge, stop, load last saved model, revert epoch number by 1, go again
